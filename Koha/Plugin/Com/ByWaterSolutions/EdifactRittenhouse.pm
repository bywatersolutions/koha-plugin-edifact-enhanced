package Koha::Plugin::Com::ByWaterSolutions::EdifactRittenhouse;
...
our $metadata = {
    name            => 'Edifact - Rittenhouse',
    author          => 'Kyle M Hall',
    description     => 'Edifact Enhanced plugin customized for Rittenhouse',
...
sub edifact {
    ...
    require Koha::Plugin::Com::ByWaterSolutions::EdifactRittenhouse::Edifact;

    my $edifact = Koha::Plugin::Com::ByWaterSolutions::EdifactRittenhouse::Edifact->new($args);
    return $edifact;
}
...
sub edifact_order {
    ...
    require Koha::Plugin::Com::ByWaterSolutions::EdifactRittenhouse::Edifact::Order;

    $args->{params}->{plugin} = $self;
    my $edifact_order = Koha::Plugin::Com::ByWaterSolutions::EdifactRittenhouse::Edifact::Order->new( $args->{params} );
...
sub edifact_transport {
    ...
    require Koha::Plugin::Com::ByWaterSolutions::EdifactRittenhouse::Edifact::Transport;

    $args->{params}->{plugin} = $self;

    my $edifact_transport = Koha::Plugin::Com::ByWaterSolutions::EdifactRittenhouse::Edifact::Transport->new( $args->{vendor_edi_account_id}, $self );
