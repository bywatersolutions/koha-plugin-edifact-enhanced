package Koha::Plugin::Com::ByWaterSolutions::EdifactBrodart;
...
our $metadata = {
    name            => 'Edifact - Brodart',
    author          => 'Kyle M Hall',
    description     => 'Edifact Enhanced plugin customized for Brodart',
...
sub edifact {
    ...
    require Koha::Plugin::Com::ByWaterSolutions::EdifactBrodart::Edifact;

    my $edifact = Koha::Plugin::Com::ByWaterSolutions::EdifactBrodart::Edifact->new($args);
    return $edifact;
}
...
sub edifact_order {
    ...
    require Koha::Plugin::Com::ByWaterSolutions::EdifactBrodart::Edifact::Order;

    $args->{params}->{plugin} = $self;
    my $edifact_order = Koha::Plugin::Com::ByWaterSolutions::EdifactBrodart::Edifact::Order->new( $args->{params} );
...
sub edifact_transport {
    ...
    require Koha::Plugin::Com::ByWaterSolutions::EdifactBrodart::Edifact::Transport;

    $args->{params}->{plugin} = $self;

    my $edifact_transport = Koha::Plugin::Com::ByWaterSolutions::EdifactBrodart::Edifact::Transport->new( $args->{vendor_edi_account_id}, $self );
