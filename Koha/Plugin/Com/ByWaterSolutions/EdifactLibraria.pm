package Koha::Plugin::Com::ByWaterSolutions::EdifactLibraria;
...
our $metadata = {
    name            => 'Edifact - Libraria',
    author          => 'Kyle M Hall',
    description     => 'Edifact plugin for Libraria',
...
sub edifact {
    ...
    require Koha::Plugin::Com::ByWaterSolutions::EdifactLibraria::Edifact;

    my $edifact = Koha::Plugin::Com::ByWaterSolutions::EdifactLibraria::Edifact->new($args);
    return $edifact;
}
...
sub edifact_order {
    ...
    require Koha::Plugin::Com::ByWaterSolutions::EdifactLibraria::Edifact::Order;

    $args->{params}->{plugin} = $self;
    my $edifact_order = Koha::Plugin::Com::ByWaterSolutions::EdifactLibraria::Edifact::Order->new( $args->{params} );
...
sub edifact_transport {
    ...
    require Koha::Plugin::Com::ByWaterSolutions::EdifactLibraria::Edifact::Transport;

    $args->{params}->{plugin} = $self;

    my $edifact_transport = Koha::Plugin::Com::ByWaterSolutions::EdifactLibraria::Edifact::Transport->new( $args->{vendor_edi_account_id}, $self );
