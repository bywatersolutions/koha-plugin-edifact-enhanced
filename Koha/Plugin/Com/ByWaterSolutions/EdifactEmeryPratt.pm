package Koha::Plugin::Com::ByWaterSolutions::EdifactEmeryPratt;
...
our $metadata = {
    name   => 'Edifact - Emery Pratt',
    author => 'Kyle M Hall',
    description => 'Edifact Enhanced plugin customized for Emery Pratt',
...
sub edifact {
    ...
    require Koha::Plugin::Com::ByWaterSolutions::EdifactEmeryPratt::Edifact;

    my $edifact = Koha::Plugin::Com::ByWaterSolutions::EdifactEmeryPratt::Edifact->new( $args );
    return $edifact;
}
...
sub edifact_order {
    ...
    require Koha::Plugin::Com::ByWaterSolutions::EdifactEmeryPratt::Edifact::Order;

    $args->{params}->{plugin} = $self;
    my $edifact_order = Koha::Plugin::Com::ByWaterSolutions::EdifactEmeryPratt::Edifact::Order->new( $args->{params} );
...
sub edifact_transport {
    ...
    require Koha::Plugin::Com::ByWaterSolutions::EdifactEmeryPratt::Edifact::Transport;

    $args->{params}->{plugin} = $self;

    my $edifact_transport = Koha::Plugin::Com::ByWaterSolutions::EdifactEmeryPratt::Edifact::Transport->new( $args->{vendor_edi_account_id}, $self );
