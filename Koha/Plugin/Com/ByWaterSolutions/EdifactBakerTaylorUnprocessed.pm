package Koha::Plugin::Com::ByWaterSolutions::EdifactBakerTaylorUnprocessed;
...
our $metadata = {
    name            => 'Edifact - Baker & Taylor - Unprocessed',
    author          => 'Kyle M Hall',
    description     => 'Edifact Enhanced plugin customized for Baker & Taylor - Unprocessed',
...
sub edifact {
    ...
    require Koha::Plugin::Com::ByWaterSolutions::EdifactBakerTaylorUnprocessed::Edifact;

    my $edifact = Koha::Plugin::Com::ByWaterSolutions::EdifactBakerTaylorUnprocessed::Edifact->new($args);
    return $edifact;
}
...
sub edifact_order {
    ...
    require Koha::Plugin::Com::ByWaterSolutions::EdifactBakerTaylorUnprocessed::Edifact::Order;

    $args->{params}->{plugin} = $self;
    my $edifact_order = Koha::Plugin::Com::ByWaterSolutions::EdifactBakerTaylorUnprocessed::Edifact::Order->new( $args->{params} );
...
sub edifact_transport {
    ...
    require Koha::Plugin::Com::ByWaterSolutions::EdifactBakerTaylorUnprocessed::Edifact::Transport;

    $args->{params}->{plugin} = $self;

    my $edifact_transport = Koha::Plugin::Com::ByWaterSolutions::EdifactBakerTaylorUnprocessed::Edifact::Transport->new( $args->{vendor_edi_account_id}, $self );
