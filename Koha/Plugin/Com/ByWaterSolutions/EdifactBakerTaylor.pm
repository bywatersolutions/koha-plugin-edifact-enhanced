package Koha::Plugin::Com::ByWaterSolutions::EdifactBakerTaylor;
...
sub edifact {
    ...
    require Koha::Plugin::Com::ByWaterSolutions::EdifactBakerTaylor::Edifact;

    my $edifact = Koha::Plugin::Com::ByWaterSolutions::EdifactBakerTaylor::Edifact->new($args);
    return $edifact;
}
...
sub edifact_order {
    ...
    require Koha::Plugin::Com::ByWaterSolutions::EdifactBakerTaylor::Edifact::Order;

    $args->{params}->{plugin} = $self;
    my $edifact_order = Koha::Plugin::Com::ByWaterSolutions::EdifactBakerTaylor::Edifact::Order->new( $args->{params} );
...
sub edifact_transport {
    ...
    require Koha::Plugin::Com::ByWaterSolutions::EdifactBakerTaylor::Edifact::Transport;

    $args->{params}->{plugin} = $self;

    my $edifact_transport = Koha::Plugin::Com::ByWaterSolutions::EdifactBakerTaylor::Edifact::Transport->new( $args->{vendor_edi_account_id}, $self );
