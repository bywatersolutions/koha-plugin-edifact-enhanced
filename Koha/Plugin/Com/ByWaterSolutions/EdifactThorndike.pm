package Koha::Plugin::Com::ByWaterSolutions::EdifactThorndike;
...
our $metadata = {
    name            => 'Edifact - Enhanced to Edifact - Thorndike',
    author          => 'Kyle M Hall',
    description     => 'Edifact plugin for Thorndike',
...
sub edifact {
    ...
    require Koha::Plugin::Com::ByWaterSolutions::EdifactThorndike::Edifact;

    my $edifact = Koha::Plugin::Com::ByWaterSolutions::EdifactThorndike::Edifact->new($args);
    return $edifact;
}
...
sub edifact_order {
    ...
    require Koha::Plugin::Com::ByWaterSolutions::EdifactThorndike::Edifact::Order;

    $args->{params}->{plugin} = $self;
    my $edifact_order = Koha::Plugin::Com::ByWaterSolutions::EdifactThorndike::Edifact::Order->new( $args->{params} );
...
sub edifact_transport {
    ...
    require Koha::Plugin::Com::ByWaterSolutions::EdifactThorndike::Edifact::Transport;

    $args->{params}->{plugin} = $self;

    my $edifact_transport = Koha::Plugin::Com::ByWaterSolutions::EdifactThorndike::Edifact::Transport->new( $args->{vendor_edi_account_id}, $self );
