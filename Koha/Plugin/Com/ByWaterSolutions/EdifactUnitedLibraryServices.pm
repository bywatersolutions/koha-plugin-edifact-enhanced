package Koha::Plugin::Com::ByWaterSolutions::EdifactUnitedLibraryServices;
...
our $metadata = {
    name            => 'Edifact - United Library Services',
    author          => 'Kyle M Hall',
    description     => 'Edifact plugin for United Library Services',
...
sub edifact {
    ...
    require Koha::Plugin::Com::ByWaterSolutions::EdifactUnitedLibraryServices::Edifact;

    my $edifact = Koha::Plugin::Com::ByWaterSolutions::EdifactUnitedLibraryServices::Edifact->new($args);
    return $edifact;
}
...
sub edifact_order {
    ...
    require Koha::Plugin::Com::ByWaterSolutions::EdifactUnitedLibraryServices::Edifact::Order;

    $args->{params}->{plugin} = $self;
    my $edifact_order = Koha::Plugin::Com::ByWaterSolutions::EdifactUnitedLibraryServices::Edifact::Order->new( $args->{params} );
...
sub edifact_transport {
    ...
    require Koha::Plugin::Com::ByWaterSolutions::EdifactUnitedLibraryServices::Edifact::Transport;

    $args->{params}->{plugin} = $self;

    my $edifact_transport = Koha::Plugin::Com::ByWaterSolutions::EdifactUnitedLibraryServices::Edifact::Transport->new( $args->{vendor_edi_account_id}, $self );
