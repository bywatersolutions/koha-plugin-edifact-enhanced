...
our $metadata = {
    name            => 'Edifact - Gobi',
    author          => 'Kyle M Hall',
    description     => 'Edifact Enhanced plugin customized for Gobi',
...
sub edifact_transport {
    ...
    my $edifact_transport
        = Koha::Plugin::Com::ByWaterSolutions::EdifactGobi::Edifact::Transport->new( $args->{vendor_edi_account_id}, $self );
