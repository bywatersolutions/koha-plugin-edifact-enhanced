package Koha::Plugin::Com::ByWaterSolutions::EdifactFindaway;
...
our $metadata = {
    name            => 'Edifact - Findaway',
    author          => 'Kyle M Hall',
    description     => 'Edifact Enhanced plugin customized for Findaway',
...
sub edifact {
    ...
    require Koha::Plugin::Com::ByWaterSolutions::EdifactFindaway::Edifact;

    my $edifact = Koha::Plugin::Com::ByWaterSolutions::EdifactFindaway::Edifact->new($args);
    return $edifact;
}
...
sub edifact_order {
    ...
    require Koha::Plugin::Com::ByWaterSolutions::EdifactFindaway::Edifact::Order;

    $args->{params}->{plugin} = $self;
    my $edifact_order = Koha::Plugin::Com::ByWaterSolutions::EdifactFindaway::Edifact::Order->new( $args->{params} );
...
sub edifact_transport {
    ...
    require Koha::Plugin::Com::ByWaterSolutions::EdifactFindaway::Edifact::Transport;

    $args->{params}->{plugin} = $self;

    my $edifact_transport = Koha::Plugin::Com::ByWaterSolutions::EdifactFindaway::Edifact::Transport->new( $args->{vendor_edi_account_id}, $self );
