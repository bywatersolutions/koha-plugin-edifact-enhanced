...
our $metadata = {
    name            => 'Edifact - LibraryBoundInc',
    author          => 'Kyle M Hall',
    description     => 'Edifact Enhanced plugin for LibraryBoundInc',
...
sub edifact_transport {
    ...
    my $edifact_transport
        = Koha::Plugin::Com::ByWaterSolutions::EdifactLibraryBoundInc::Edifact::Transport->new( $args->{vendor_edi_account_id}, $self );
