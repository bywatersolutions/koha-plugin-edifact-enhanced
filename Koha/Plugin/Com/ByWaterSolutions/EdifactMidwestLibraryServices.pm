package Koha::Plugin::Com::ByWaterSolutions::EdifactMidwestLibraryServices;
...
our $metadata = {
    name   => 'Edifact - Midwest Library Services',
    author => 'Kyle M Hall',
    description => 'Edifact Enhanced plugin customized for Midwest Library Services',
...
sub edifact {
    ...
    require Koha::Plugin::Com::ByWaterSolutions::EdifactMidwestLibraryServices::Edifact;

    my $edifact = Koha::Plugin::Com::ByWaterSolutions::EdifactMidwestLibraryServices::Edifact->new( $args );
    return $edifact;
}
...
sub edifact_order {
    ...
    require Koha::Plugin::Com::ByWaterSolutions::EdifactMidwestLibraryServices::Edifact::Order;

    $args->{params}->{plugin} = $self;
    my $edifact_order = Koha::Plugin::Com::ByWaterSolutions::EdifactMidwestLibraryServices::Edifact::Order->new( $args->{params} );
...
sub edifact_transport {
    ...
    require Koha::Plugin::Com::ByWaterSolutions::EdifactMidwestLibraryServices::Edifact::Transport;

    $args->{params}->{plugin} = $self;

    my $edifact_transport = Koha::Plugin::Com::ByWaterSolutions::EdifactMidwestLibraryServices::Edifact::Transport->new( $args->{vendor_edi_account_id}, $self );
