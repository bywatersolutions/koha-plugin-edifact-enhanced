...
our $metadata = {
    name   => 'Edifact - Ingram',
    author => 'Kyle M Hall',
    description => 'Edifact Enhanced plugin for Ingram',
...
sub edifact_transport {
    ...
    my $edifact_transport = Koha::Plugin::Com::ByWaterSolutions::EdifactIngram::Edifact::Transport->new( $args->{vendor_edi_account_id}, $self );
