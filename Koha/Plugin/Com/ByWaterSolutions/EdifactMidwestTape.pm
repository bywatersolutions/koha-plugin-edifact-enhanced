package Koha::Plugin::Com::ByWaterSolutions::EdifactMidwestTape;
...
our $metadata = {
    name            => 'Edifact - Midwest Tape',
    author          => 'Kyle M Hall',
    description     => 'Edifact Enhanced plugin customized for Midwest Tape',
...
sub edifact {
    ...
    require Koha::Plugin::Com::ByWaterSolutions::EdifactMidwestTape::Edifact;

    my $edifact = Koha::Plugin::Com::ByWaterSolutions::EdifactMidwestTape::Edifact->new($args);
    return $edifact;
}
...
sub edifact_order {
    ...
    require Koha::Plugin::Com::ByWaterSolutions::EdifactMidwestTape::Edifact::Order;

    $args->{params}->{plugin} = $self;
    my $edifact_order = Koha::Plugin::Com::ByWaterSolutions::EdifactMidwestTape::Edifact::Order->new( $args->{params} );
...
sub edifact_transport {
    ...
    require Koha::Plugin::Com::ByWaterSolutions::EdifactMidwestTape::Edifact::Transport;

    $args->{params}->{plugin} = $self;

    my $edifact_transport = Koha::Plugin::Com::ByWaterSolutions::EdifactMidwestTape::Edifact::Transport->new( $args->{vendor_edi_account_id}, $self );
